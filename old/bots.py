...
######################################################
    ...
    'mesa': 
    {
        ...
        'behaviors': {
            'on_mention': {
                'probability': 1.0,
                'channels': [777028140085018664, 758719600895590444, 758719600895590441, 741757454894891071],
                'delay': [0, 1],
                'program': 'spotify'
            },            
            'timed': [{
...
######################################################
    ...
    'chatsubo': 
    {
        ...
        'behaviors': {
            'on_message': {                
                'probability': 0.08,
                'channels': [777028140085018664, 758719600895590444, 741757454894891071, 759864082383110154, 761619228482076703, 748633305230082269, 758834882599976970, 761627656558084107, 761709792405880833, 761709792405880833, 764623050993434655, 761629924166598667],
                'program': 'gpt3_chat'                
            },
            'on_mention': {
                'probability': 1.0,
...
######################################################
    ...
    'eve': 
    {
        ...
        'behaviors': {
            'on_message': {                
                'probability': 0.02,
                'channels': [777028140085018664, 758719600895590444],
                'program': 'gpt3_chat'                
            },
            'on_mention': {
                'probability': 1.0,
